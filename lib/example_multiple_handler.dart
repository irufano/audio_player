...
// // global variable.
// late AudioHandler _audioPlayerService.handler;
...
class MainScreen extends StatelessWidget {
                ...
                return Column(
                  ...
                  children: [
                    StreamBuilder<dynamic>(
                      stream: _audioPlayerService.handler.customState,
                      builder: (context, snapshot) {
                        final handlerIndex =
                        ...
                        return DropdownButton<int>(
                          ...
                          onChanged:
                              _audioPlayerService.handler.switchToHandler,
                        );
                      },
                    ),
  ...
  IconButton _stopButton() => IconButton(
        ...
        iconSize: 64.0,
        onPressed: _audioPlayerService.handler.stop,
      );
}
